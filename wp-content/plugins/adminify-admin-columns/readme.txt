...
Tags: admin columns, column editor
...
Adminify Admin Columns Description


== Installation ==

### Liked Adminify Admin Columns Plugins?
Rate us on [WordPress Forum](https://wordpress.org/support/plugin/adminify-admin-columns/reviews/#new-post) 🙂
...
If you like our Adminify Admin Columns plugin then why not check some other plugins that developed by us:
